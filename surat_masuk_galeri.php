        ...
        if(isset($_REQUEST['act'])){
            ...
            echo '
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    $query = mysqli_query($_config, "SELECT * FROM tbl_surat_masuk WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC");
                                ...
                                if(in_array($eks, $ekstensi) == true){
                                    echo '
                                        <div class="col m3">
                                            ...
                                            <a class="btn light-green darken-1" href="?page=gsm&act=fsm&id_surat='.urlencode(encrypt($string, $salt)).'">Tampilkan Ukuran Penuh</a>
                                        </div>';
                                } else {
                                    ...
                                    if(in_array($eks, $ekstensi2) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn light-green darken-1" href="?page=gsm&act=fsm&id_surat='.urlencode(encrypt($string, $salt)).'">Lihat Detail File</a>
                                            </div>';
                                    } else {
                                        echo '
                                            <div class="col m3">
                    ...
                    $query = mysqli_query($_config, "SELECT * FROM tbl_surat_masuk ORDER BY id_surat DESC LIMIT $curr, $limit");
                    if(mysqli_num_rows($query) > 0){
                        ...
                        $query = mysqli_query($_config, "SELECT * FROM tbl_surat_masuk");
