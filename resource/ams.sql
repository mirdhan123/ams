...
--
-- Host: localhost
-- Generation Time: Jul 17, 2016 at 07:23 
...
(5, 'Kesiswaan', 'Kirimkan siswa kelas 12 untuk mengikuti kegiatan Pameran Bursa Kerja Untuk Percepatan Tenaga Kerja / Job Fair Tahun 2016 ', 'Biasa', '2016-05-17', 'Segera Laksanakan', 6),
(6, 'Panitia Zakat Fitrah', 'Segera koordinasi pembagian zakat fitrah', 'Biasa', '2016-07-15', 'Semua siswa wajib membayar zakat fitrah disekolah', 5),
(7, 'Bendahara Sekolah', 'Segera siapkan berkas-berkas yang diperlukan', 'Biasa', '2016-07-17', 'Segera Laksanakan', 4);
...
(1, 'SMK AL - Husna Loceret Nganjuk', 'Jalan Raya Kediri Gg. Kwagean No. 04 Loceret Telp/Fax. (0358) 329806 Nganjuk 64471', 'H. Riza Fachri, S.Kom.', '-', 'http://www.smkalhusnaloceret.sch.id', 'info@smkalhusnaloceret.sch.id', 'logo.png');
...
(6, 'A', 'Pendidikan', 'Pendidikan Sekolah Menengah Kejuruan', 1),
(7, 'B', 'Sarana', 'Bangunan Sekolah dan Sarana Pendukung Lainnya', 1),
(8, 'C', 'Kurikulum', 'Kurikulum 2016', 1),
(9, 'D', 'Kegiatan', 'Ekstrakurikuler', 1),
(10, 'E', 'Administrasi', 'Administrasi Keuangan', 1);
...
--
ALTER TABLE `tbl_klasifikasi`
MODIFY `id_klasifikasi` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
