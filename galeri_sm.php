                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        echo '<!-- Row form Start -->
                            ...
                            <div class="row agenda">
                                <div class="col s12">
                                    <p class="warna agenda">Galeri file surat masuk antara tanggal <strong>'.date('d M Y', strtotime($dari_tanggal)).'</strong> sampai dengan tanggal <strong>'.date('d M Y', strtotime($sampai_tanggal)).'</strong></p>
                                </div>
                            </div>';
