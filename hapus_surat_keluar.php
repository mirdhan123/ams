    	...
    	if(mysqli_num_rows($query) > 0){
            ...
            while($row = mysqli_fetch_array($query)){
    		  ...
    		  echo '<!-- Row form Start -->
		        ...
		        <div class="row bts">
		            <div class="col 6">
		                <a href="?page=tsk&aksk=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large deep-orange waves-effect waves-light">HAPUS <i class="material-icons">delete</i></a>
		            </div>
		            <div class="col 6">
            	...
            	if(isset($_REQUEST['submit'])){
            		...
            		if($query == true){
                        ...
                        window.location.href="./admin.php?page=tsk&aksk=del&id_surat='.$id_surat.'";
                        </script>';
            		}
            	}
		    }
