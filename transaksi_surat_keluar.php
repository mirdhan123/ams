                ...
                <div class="z-depth-1">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <div class="col m7">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">drafts</i> Surat Keluar</a></li>
                                    <li class="waves-effect waves-light">
                                        <a href="tambah_surat_keluar.php"><i class="material-icons md-24">add_circle</i> Tambah Data Surat Keluar</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col m5">
                                <form>
                                    <div class="input-field round-in-box">
                                        <input id="search" type="search" placeholder="Ketik dan tekan enter untuk mencari data..." required>
        ...
        <div class="row jarak-form">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <ul id='dropdown1' class='dropdown-content'>
                                    <li class="cyan"><a href="edit_surat_keluar.php"><i class="material-icons">edit</i> EDIT</a></a></li>
                                    <li class="divider"></li>
            ...
            <div id="hapus" class="modal">
                <div class="modal-content">
                    <h5 class="redtext"><i class="material-icons md-36 md-red">error_outline</i> Konfirmasi</h5>
