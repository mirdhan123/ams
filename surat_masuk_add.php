    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['isi'] == ""
                || $_REQUEST['kode'] == "" || $_REQUEST['indeks'] == "" || $_REQUEST['tgl_surat'] == ""){
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col m6 tooltipped" data-position="top" data-tooltip="Kode klasifikasi diambil dari data Klasifikasi">
                        ...
                        <div class="input-field col m6 tooltipped" data-position="top" data-tooltip="Indeks lokasi penyimpanan surat">
